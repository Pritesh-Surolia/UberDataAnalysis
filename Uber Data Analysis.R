...
apr <- read.csv("C:\\Users\\surol\\Downloads\\uber-raw-data-apr14\\uber-raw-data-apr14.csv", header = TRUE, sep = ",")
may <- read.csv("C:\\Users\\surol\\Downloads\\uber-raw-data-apr14\\uber-raw-data-may14.csv")
june <- read.csv("C:\\Users\\surol\\Downloads\\uber-raw-data-apr14\\uber-raw-data-jun14.csv")
july <- read.csv("C:\\Users\\surol\\Downloads\\uber-raw-data-apr14\\uber-raw-data-jul14.csv")
aug <- read.csv("C:\\Users\\surol\\Downloads\\uber-raw-data-apr14\\uber-raw-data-aug14.csv")
sep <- read.csv("C:\\Users\\surol\\Downloads\\uber-raw-data-apr14\\uber-raw-data-sep14.csv")
